...
window.onload = function() {
   document.forms[0].onsubmit = function() {
      if (this.checkValidity()) alert("Thank you for submitting your info! Unfortunately this form is non-functional at the moment, so instead you're welcome to reach me at the information listed on my resume! Feel free to read through the rest of this website.");
      return false;
   };
};